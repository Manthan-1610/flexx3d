...
const Navbar = () => {
  ...
  return (
    <div className="p-1 md:p-4 flex items-center justify-between h-12 w-full">
      <div className="flex flex-row items-center gap-2">
        <img src={logo} alt="" height={100} width={120} className="dark:hidden" />
        <img
          src={gif}
          alt=""
          height={20}
      ...
      <ul className="hidden md:flex text-md  text-black dark:text-white font-semibold md:tracking-wide  flex-col  gap-2 md:flex-row  md:gap-8">
        <li>
